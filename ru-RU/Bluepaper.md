...
Скорость создания новых токенов была установлена в размере 9,5% в год начиная с декабря 2016 года и уменьшается в размере 0,01% каждые 250,000 блоков, что равно примерно 0,05% в год. Инфляция продолжит снижать этот показатель, пока он не достигнет 0.95%, спустя период примерно в 20,5 лет.
