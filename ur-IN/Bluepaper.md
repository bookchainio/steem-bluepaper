...
سٹیم عوامی طور پر قابل رسائی«٠»١«\٠» اور امت مواد کے ساتھ ساتھ تیز اور مفت ڈچٹل ٹکون(جس کو سٹیم کہاتے ھے)«١»٢«\١»جس کی بدولت لوگ اپنے دماغ استعمال کرکے پیسے کما سکتے ہیں(جس کو دماغ کا ہونا بھی کہ سکتے ہے) The two building blocks of this protocol, both blockchain and token, depend on each other for security, immutability and longevity, and are therefore integral to each others’ existence. سٹیام کامیابی کے لیے ایک سال سے کام کر رہا ہے اور اب دونوں بٹ کوان اور اتریوم کو لین دین کی عمل کاری کی تعداد میں آگے نکل گیا ہے۔[^3]
