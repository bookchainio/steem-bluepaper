...
Comparado con otros blockchains, Steem se destaca como la primera base de datos de acceso público, para el contenido inmutable almacenado en forma de texto plano, junto con un mecanismo de incentivación incorporado. This makes Steem a public publishing platform from which any Internet application may pull and share data while rewarding those who contribute the most valuable content.
