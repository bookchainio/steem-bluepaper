...
Kada ga uporedimo sa drugim blockchain-ovima, Steem se izdvaja jer predstavlja prvu javno dostupnu bazu podataka za nepromenljiv sadržaj u obliku "čistog teksta" (eng. "plain text"), uz koji dolazi i ugrađeni mehanizam za nagrađivanje. This makes Steem a public publishing platform from which any Internet application may pull and share data while rewarding those who contribute the most valuable content.
