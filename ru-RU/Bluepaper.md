...
С практической точки зрения AppBase задействует разные ядра или даже разные компьютеры для поддержания разных частей блокчейна Steem. Это значительнее эффективней, чем запрашивать каждое ядро и каждый компьютер в сети поддерживать целиком весь блокчейн. Modularizing the blockchain enables it to take full advantage of the modular nature of computers. This is one necessary step in the long process of creating a fully parallel, fully optimized blockchain.
