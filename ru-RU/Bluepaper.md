...
Steem предлагает вашему вниманию масштабируемый блокчейн-протокол [^1]для неизменного и общедоступного контента, а также быстрый в использовании и обладающий малой комиссией цифровой токен (под названием STEEM)[^2],позволяющий людям зарабатывать деньги используя собственную голову (что можно назвать "доказательство мозгов". Обе составляющие этого протокола, и блокчейн и монета, зависят от безопасности, неизменяемости и долгосрочности друг друга, поэтому являются неотъемлемыми частями одного целого. Steem успешно действует уже более года и в настоящее время обошёл Bitcoin и Ethereum по количеству проведённых транзакций.[^3]
