...
Steem предоставляет масштабируемый блокчейн-протокол [^1]для общедоступного и постоянного контента, а также быстрый в использовании и обладающий скромной комиссией цифровой токен (под названием STEEM)[^2], который позволяет людям получать выплаты за использование своих мозгов (что можно назвать "доказательство мозгов"). Оба строительных блока этого протокола, блокчейн и монета, зависят от безопасности, неизменности и долгосрочности друг друга, поэтому являются неотъемлемой частью существования друг друга. Steem успешно действует уже более года и в настоящее время обошёл Bitcoin и Ethereum по количеству проведённых транзакций.[^3]
...
Нередко испытывая затруднения в связи с использованием алгоритма Доказательство Работы (Proof-of-Work, PoW)[^6], многие блокчейны не способны выйти за пределы масштабирования более трёх транзакций в секунду и это становится частью мирового финансового траффика. Steem нуждается в куда большем масштабе и скорости, чем способен предложить PoW, поэтому за основу блокчейна взят не такой известный алгоритм под названием Делегированное Доказательство Долей (Delegated Proof of Stake, DPoS)[^7], который, тем не менее, пригоден для эксплуатации миллиардами пользователей.
...
Согласно правилам, когда случается Хардфорк, избранные в рамках DPoS заверители могут быстро и эффективно решить, следует ли проводить хардфорк или нет, позволяя блокчейн протоколу Steem развиваться быстрее большинства других. Блокчейн Steem уже был благополучно форкнут 18 раз[^8] и после каждого хардфорка продолжала существовать только одна цепочка.
