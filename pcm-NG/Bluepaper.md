...
Inside de field of crypto-currencies, de unique properties of STEEM make am both "smart" and "social" compared to ods, like bitcoin and ether. Dis stems from two new token features. De first na pool of tokens wey dem dedicated to incentivizing content creation and curation (called de "rewards pool"). De second na voting system wey leverages de wisdom wey de crowd fit assess de value of content and distribute token for am. These two unique properties if dem combined fit referred am as Proof-of-Brain, wey be entendre based on Proof-of-Work[^4], fit to emphasize de human work wey dem need to distribute tokens to community participants. Proof-of-Brain positions STEEM as tool way dem take dey build perpetually growing communities, wey encourage dem members take add value for the community thru de built for rewards structure.

In addition to these advancements for blockchain and token technology, Steem like system dey provides another advanced features wey enhance de person experience, like Stolen Account Recovery[^5], escrow services, user promoted content, a reputation system, and savings accounts. Dem do all dis while dem providing users with three second confirmation times and zero fees ontop all de transactions. All this wan allow am to support the mission of bringing smart and social currency to publishers and community builders across de internet.
...
De rate wey new tokens dey generate dem set am to 9.5% per year starting in December 2016, and reduce to de rate of 0.01% every 250,000 blocks, or about 0.5% per year. De inflation go continue to dey reduce for dis rate until e reach 0.95% after some period of about 20.5 years.
