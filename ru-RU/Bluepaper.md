...
Неизменяемый реестр блокчейна Steem предлагает пользователям уникальную возможность непосредственно публиковать и перманентно хранить различные виды контента в виде обычного текста. Попав в блокчейн, данные становятся публично доступными разработчикам для работы с ними. Разработчики могут напрямую взаимодействовать с контентом в блокчейне при помощи доступных API. Разработчики могут использовать для своих проектов такие базисные элементы, как Имена аккаунтов, Публикации, Комментарии, Голоса и Баланс аккаунтов.
