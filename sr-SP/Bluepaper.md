...
Захваљујући DPoS алгоритму, Steem blockchain је у стању да генерише нови блок на сваке 3 секунде уз минимално оптерећење рачунара. This means that the blockchain can process more transactions and hold more information, including content.
