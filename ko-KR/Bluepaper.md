...
또한, 스팀은 세 가지 키가 모두 암호화되어 있는 마스터 패스워드를 사용할 수 있습니다. 웹 서비스에서는 필요한 개인 키로 서명하고 복호화할 때 마스터 패스워드를 사용할 수 있습니다. 클라이언트 기반 서명 환경을 안전하게 유지하면서도 사용자 경험을 향상시키고, 부적절한 키가 다른 서버로 전송되는 것을 보호하기 위해 특정 서비스를 신뢰하는데 마스터 패스워드를 사용할 수 있습니다.
