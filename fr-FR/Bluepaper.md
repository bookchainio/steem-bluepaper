...
Par rapport aux autres blockchains, Steem s’impose comme la première base de données accessible au public pour contenu immuable stocké sous forme de texte brut, avec un mécanisme d’incitation en construction. This makes Steem a public publishing platform from which any Internet application may pull and share data while rewarding those who contribute the most valuable content.
