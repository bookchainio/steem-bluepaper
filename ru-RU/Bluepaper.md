...
Лимиты пропускной способности зависят от загруженности сети: так, пропускная способность возрастает при низком уровне использования сети. Объём допустимой пропускной способности аккаунта прямо пропорционален количеству Steem Power, которой обладает пользователь, поэтому пользователи всегда могут увеличивать свою пропускную способность увеличивая свой Steem Power.
