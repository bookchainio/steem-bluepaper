...
En comparanza con outras Blockchains, Steem xurde como a primeira base de datos públicamente accesible con almacenamento inmuitable para contido almaceado en forma de texto plano, que incorpora un mecanismo de incentivos. Isto fai Steem unha plataforma pública de publicación a cal, dende calquera aplicación pode extraer e partillar datos o tempo que recompensa a aquelas que contribuen co contido mais valioso. This makes Steem a public publishing platform from which any Internet application may pull and share data while rewarding those who contribute the most valuable content.
