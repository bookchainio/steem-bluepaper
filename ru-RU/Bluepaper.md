...
В отличие от других блокчейнов, Steem является первой базой данных с публичным доступом дл хранения постоянного контента в виде простого текста. Также он обладает встроенным механизмом мотивации. Это делает Steem платформой для общественных публикаций, с которой любое Интернет-приложение способно обмениваться информацией и которое может награждать тех, кто размещает наиболее ценный контент.
