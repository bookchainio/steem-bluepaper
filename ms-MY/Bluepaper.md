...
### Struktur Hierarki Kunci Peribadi

Steem menggajikan sistem hierarki kunci peribadinya yang pertama bagi seumpamanya untuk memudahkan urus niaga yang mempunyai tahap keselamatan yang rendah dan tinggi. Urus niaga yang tahap keselamatannya rendah selalunya bersifat sosial, seperti membuat hantaran atau komen. Urus niaga yang tahap keselamatannya tinggi selalunya merupakan pemindahan dan perubahan penting. This allows users to implement different levels of security for their keys, depending on the access that the keys allow.
