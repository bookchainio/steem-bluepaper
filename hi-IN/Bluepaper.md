...
<p>
  स्टीम अपने उपयोगकर्ताओं को प्रकाशित करने की क्षमता और सामग्री को विभिंन प्रकार से जम्मह करता है और स्थाई रूप से पाठ के रूप में ब्लॉकचैन के लेज़र में प्रदान करता है । एक बार ब्लॉक्चैन मै संग्रहीत होने पर सामग्री डेवलपर्स को निर्माण करने के लिए उपलब्ध हो जाता हैं | Developers are able to interact with the content directly in the blockchain using the available APIs. Several of the blockchain primitives developers can build from include Account Names, Posts, Comments, Votes and Account Balance.
</p>
