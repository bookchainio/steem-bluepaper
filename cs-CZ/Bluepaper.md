...
Ve srovnání s jinými blockchainy je Steem první veřejně dostupná databáze neměnného obsahu uloženého ve formě prostého textu. Vyniká také zabudovaným mechanismem motivačních odměn. This makes Steem a public publishing platform from which any Internet application may pull and share data while rewarding those who contribute the most valuable content.
