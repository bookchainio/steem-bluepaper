...
Блокчейн Steem предлагает услуги децентрализованной биржи токенов, схожей с биржей Bitshares.[^13] Она позволяет пользователям торговать своими токенами STEEM и SBD на публичном децентрализованном одноранговом рынке. Пользователи могут размещать заявки на покупку и продажу, а сверка приказов автоматически выполнятся блокчейном. Также существует публично доступный биржевой стакан и история сделок, которые пользователи могут применять для анализа рынка. Пользователи имеют возможность действовать на бирже непосредственно при помощи программного интерфейса блокчейна или пользовательского графического интерфейса на сайте Steemit.com. [^14]
...
Блокчейн Steem предоставляет возможность разделить права на несколько субъектов. Так несколько пользователей могут совместно использовать один авторитет, а для полноценной авторизации транзакции требуется несколько субъектов. Это осуществляется сходным с Bitshares [^16] способом, когда за каждой парой публичного и приватного ключей закрепляется вес, определяющий порог для авторитета. Для вступления транзакции в силу должное количество субъектов должно подписаться таким образом, чтобы их вес в сумме совпал с порогом или превысил его.
...
В случаях обнаружения взлома аккаунта, пользователи могут изменить свои ключи при помощи приватного ключа владельца. В том случае, если злоумышленник смог взломать приватный ключ владельца и сменить пароль аккаунта, у пользователя есть 30 дней чтобы предоставить ранее действующий приватный ключ для восстановления контроля над собственным аккаунтом при помощи новой технологии Steem - процесса восстановления украденного аккаунта. Эта возможность предоставляется частным лицам и компаниям, которые предоставляют услуги регистрации на Steem. Для регистратора не является обязательным предоставлять подобную услугу для своих пользователей, но она есть доступна и позволяет улучшить опыт, получаемого пользователями этого регистратора.

### Безопасность с временным сейфом

Если активный ключ или ключ владелеца пользователя взломаны, то злоумышленник получает полный доступ ко всем финансовым средствам аккаунта. Поскольку транзакции в блокчейне не подлежат отмене, пользователи не имеют возможности получить свои деньги назад после того, как были украдены.
...
### Ограничение пропускной способности для операций без комиссий

Поскольку работа заверителей целиком оплачивается через создание новых токенов, исчезает необходимость взимать плату с пользователей для обеспечения работы блокчейна. Единственной причиной для установления платы может быть потребность сдерживать пользователей от проведения необоснованного количества транзакций, способных негативно повлиять на производительность блокчейна.

Для того, чтобы установить разумный лимит на использование системы, каждый пользователь получает лимит пропускной способности. Всякий раз, когда пользователи выполняют на блокчейне операции вроде перевода токенов, размещения контента и голосования, они используют часть своей пропускной способности. Если пользователь израсходовал весь лимит свей пропускной способности, то ему придётся дождаться её восстановления.
...
Уникальные вознаграждения и программы мотивации, предлагаемые блокчейном Steem и возможностями токена, призваны сделать Steem точкой окончательного перехода мейнстримовых пользователей к криповалютам. Функционал блокчейна разработан для принятия валюты и платформы широкими массами. Сочетание с молниеносных процессов и микроскопических комиссий за транзакции ставит Steem положение одной из лидирующих блокчейн технологий в мире.
