...
Од нових токена које Steem blockchain креира сваке године, 75% токена чине "наградни фонд" који се дистрибуира ауторима садржаја и гласачима. 15% are distributed to vested token holders, and 10% are distributed to Witnesses, the block producers cooperating inside Steem’s DPoS consensus protocol.
