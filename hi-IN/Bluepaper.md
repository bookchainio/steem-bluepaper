...
<p>
  इन निजी चाबियां पोस्टिंग, सक्रिय और अधिकारी हैं । पोस्टिंग कुंजी खाते पर पोस्ट, टिप्पणी, संपादित करें, वोट, रिस्टीम <fnref target="15" /> और फ़ालो या म्यट करने के लिए अनुमति देता हैं | सक्रिय कुंगी संवेदनशील कार्यों जैसे धन हस्तांतरण, पावर अप/नीचे करने का लेनदेन, स्टीम डॉलर बदलने, गवाहों को वोट करना, बाज़ार चलाने, और पोस्टिंग कुंजी को बदलने के लिए इस्तेमाल होती हैं | The owner key is only meant for use when necessary. It is the most powerful key because it can change any key of an account, including the owner key, and to prove ownership during an Account Recovery. Ideally it is meant to be stored offline, and only used when the account’s keys need to be changed or to recover a compromised account.
</p>
